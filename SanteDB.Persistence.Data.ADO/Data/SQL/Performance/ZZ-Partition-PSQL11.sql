/** 
 * <feature scope="SanteDB.Persistence.Data.ADO.Performance" id="ZZ-PARTITION-PGSQL11" name="Performance: Partition PostgreSQL" applyRange="1.0.0.3-1.0.0.0"  invariantName="npgsql">
 ...
 *	<isInstalled>select ck_patch('ZZ-PARTITION-PGSQL11')</isInstalled>
 *	<canInstall>select version() ilike '%postgresql 11.%' </canInstall>
 * </feature>
 */
...
CREATE TABLE act_ptcpt_part_oth_tbl PARTITION OF act_ptcpt_part_tbl DEFAULT;
...
CREATE TABLE ent_rel_part_oth_tbl PARTITION OF ent_rel_part-tbl DEFAULT;
...
CREATE TABLE act_part_tbl
(
  act_id uuid NOT NULL DEFAULT uuid_generate_v4(),
  tpl_id uuid,
  cls_cd_id uuid NOT NULL,
  mod_cd_id uuid NOT NULL,
  CONSTRAINT ck_act_cls_cd CHECK (ck_is_cd_set_mem(cls_cd_id, 'ActClass'::character varying, false)),
  CONSTRAINT ck_act_mod_cd CHECK (ck_is_cd_set_mem(mod_cd_id, 'ActMood'::character varying, false))
) PARTITION BY LIST (cls_cd_id);

CREATE TABLE act_part_obs_tbl PARTITION OF act_part_tbl FOR VALUES IN ('28d022c6-8a8b-47c4-9e6a-2bc67308739e');
CREATE TABLE act_part_enc_tbl PARTITION OF act_part_tbl FOR VALUES IN ('54b52119-1709-4098-8911-5df6d6c84140');
CREATE TABLE act_part_sbadm_tbl PARTITION OF act_part_tbl FOR VALUES IN ('932a3c7e-ad77-450a-8a1f-030fc2855450');
CREATE TABLE act_part_acct_tbl PARTITION OF act_part_tbl FOR VALUES IN ('ca44a469-81d7-4484-9189-ca1d55afecbc');
CREATE TABLE act_part_oth_tbl PARTITION OF act_part_tbl DEFAULT;

--#!
INSERT INTO act_part_tbl SELECT * FROM act_tbl;
--#!

CREATE INDEX act_part_oth_tbl ON act_cls_cd_idx (cls_cd_id);

ALTER TABLE act_part_obs_tbl ADD CONSTRAINT pk_act_part_obs_tbl PRIMARY KEY (act_id);
ALTER TABLE act_part_enc_tbl ADD CONSTRAINT pk_act_part_enc_tbl PRIMARY KEY (act_id);
ALTER TABLE act_part_sbadm_tbl ADD CONSTRAINT pk_act_part_sbadm_tbl PRIMARY KEY (act_id);
ALTER TABLE act_part_acct_tbl ADD CONSTRAINT pk_act_part_acct_tbl PRIMARY KEY (act_id);
ALTER TABLE act_part_oth_tbl ADD CONSTRAINT pk_act_part_oth_tbl PRIMARY KEY (act_id);
--#!

ALTER TABLE act_part_obs_tbl ADD CONSTRAINT fk_act_part_obs_tpl_id FOREIGN KEY (tpl_id) REFERENCES tpl_def_tbl (tpl_id);
ALTER TABLE act_part_enc_tbl ADD CONSTRAINT fk_act_part_enc_tpl_id FOREIGN KEY (tpl_id) REFERENCES tpl_def_tbl (tpl_id);
ALTER TABLE act_part_sbadm_tbl ADD CONSTRAINT fk_act_part_sbadm_tpl_id FOREIGN KEY (tpl_id) REFERENCES tpl_def_tbl (tpl_id);
ALTER TABLE act_part_acct_tbl ADD CONSTRAINT fk_act_part_acct_tpl_id FOREIGN KEY (tpl_id) REFERENCES tpl_def_tbl (tpl_id);
ALTER TABLE act_part_oth_tbl ADD CONSTRAINT fk_act_part_oth_tpl_id FOREIGN KEY (tpl_id) REFERENCES tpl_def_tbl (tpl_id);
--#!

ALTER TABLE act_part_obs_tbl ADD CONSTRAINT fk_act_part_obs_mod_cd_id FOREIGN KEY (mod_cd_id) REFERENCES cd_tbl (cd_id);
ALTER TABLE act_part_enc_tbl ADD CONSTRAINT fk_act_part_enc_mod_cd_id FOREIGN KEY (mod_cd_id) REFERENCES cd_tbl (cd_id);
ALTER TABLE act_part_sbadm_tbl ADD CONSTRAINT fk_act_part_sbadm_mod_cd_id FOREIGN KEY (mod_cd_id) REFERENCES cd_tbl (cd_id);
ALTER TABLE act_part_acct_tbl ADD CONSTRAINT fk_act_part_acct_mod_cd_id FOREIGN KEY (mod_cd_id) REFERENCES cd_tbl (cd_id);
ALTER TABLE act_part_oth_tbl ADD CONSTRAINT fk_act_part_oth_mod_cd_id FOREIGN KEY (mod_cd_id) REFERENCES cd_tbl (cd_id);
--#!

ALTER TABLE act_part_obs_tbl ADD CONSTRAINT fk_act_part_obs_cls_cd_id FOREIGN KEY (cls_cd_id) REFERENCES cd_tbl (cd_id);
ALTER TABLE act_part_enc_tbl ADD CONSTRAINT fk_act_part_enc_cls_cd_id FOREIGN KEY (cls_cd_id) REFERENCES cd_tbl (cd_id);
ALTER TABLE act_part_sbadm_tbl ADD CONSTRAINT fk_act_part_sbadm_cls_cd_id FOREIGN KEY (cls_cd_id) REFERENCES cd_tbl (cd_id);
ALTER TABLE act_part_acct_tbl ADD CONSTRAINT fk_act_part_acct_cls_cd_id FOREIGN KEY (cls_cd_id) REFERENCES cd_tbl (cd_id);
ALTER TABLE act_part_oth_tbl ADD CONSTRAINT fk_act_part_oth_cls_cd_id FOREIGN KEY (cls_cd_id) REFERENCES cd_tbl (cd_id);
--#!

ALTER TABLE act_tbl RENAME TO act_tbl_bak;
ALTER TABLE act_part_tbl RENAME TO act_tbl;
--#!
