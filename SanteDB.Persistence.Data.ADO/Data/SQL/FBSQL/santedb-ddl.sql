...
CREATE TABLE PHON_VAL_TBL (
	VAL_SEQ_ID NUMERIC(10) NOT NULL, -- UNIQUE IDENTIFIER FORHTE VALUE
...
CREATE TABLE CD_SET_TBL (
	...
	UPD_USR_ID UUID, -- THE CHAR(16) OF THE USER WHICH UPDATED THE CONCEPT SET
...
CREATE TABLE CD_VRSN_TBL (
	...
	VRSN_SEQ_ID NUMERIC(10) UNIQUE NOT NULL,-- VERSION SEQUENCE
...
CREATE TABLE CD_NAME_TBL (
	...
	EFFT_VRSN_SEQ_ID NUMERIC(10) NOT NULL, -- THE VERSION SEQUENCE WHERE THIS BECOMES EFFECTIVE
	OBSLT_VRSN_SEQ_ID NUMERIC(10), -- THE VERSION SEQUENCE WHERE THIS IS NO LONGER EFFECTIVE
...
CREATE TABLE CD_REF_TERM_ASSOC_TBL (
	...
	EFFT_VRSN_SEQ_ID NUMERIC(10) NOT NULL, -- THE VERSION AT WHICH THE REFERENCE TERM RELATIONSHIP BECAME ACTIVE
	OBSLT_VRSN_SEQ_ID NUMERIC(10), -- THE VERSION AT WHICH THE REFERENCE TERM IS NO LONGER ACTIVE
...
CREATE TABLE CD_REL_ASSOC_TBL (
	...
	EFFT_VRSN_SEQ_ID NUMERIC(10) NOT NULL, -- THE VERSION AT WHICH THE RELATIONSHIP BECOMES ACTIVE
	OBSLT_VRSN_SEQ_ID NUMERIC(10), -- THE VERSION AT WHICH THE RELATIONSHIP IS NO LONGER ACTIVE
...
CREATE TABLE ACT_VRSN_TBL (
	...
	VRSN_SEQ_ID NUMERIC(10) UNIQUE NOT NULL, -- THE VERSION SEQUENCE
...
CREATE TABLE ACT_ID_TBL (
	...
	EFFT_VRSN_SEQ_ID NUMERIC(10) NOT NULL, -- THE VERSION AT WHICH TIME THIS IDENTIIFER BECAME ACTIVE
	OBSLT_VRSN_SEQ_ID NUMERIC(10), -- THE VERSION SEQUENCE AT WHICH THE IDENTIFIER WAS NO LONGER ACTIVE
...
CREATE TABLE ACT_REL_TBL (
	...
	EFFT_VRSN_SEQ_ID NUMERIC(10) NOT NULL, -- EFFECTIVE VERSION OF THE RELATIONSHIP
	OBSLT_VRSN_SEQ_ID NUMERIC(10), -- THE OBSOLETION VERSION OF THE RELATIONSHIP
...
CREATE TABLE ACT_EXT_TBL (
	...
	EFFT_VRSN_SEQ_ID NUMERIC(10) NOT NULL, -- THE VERSION AT WHICH THE EXTENSION IS ACTIVE
	OBSLT_VRSN_SEQ_ID NUMERIC(10), -- THE VERSION AT WHICH THE EXTENSION IS NOT ACTIVE
...
CREATE TABLE ACT_POL_ASSOC_TBL (
	...
	EFFT_VRSN_SEQ_ID NUMERIC(10) NOT NULL, -- THE VERSION OF THE ACT WHERE THE POLICY ASSOCIATION DID BECOME ACTIVE
	OBSLT_VRSN_SEQ_ID NUMERIC(10), -- THE VERSION OF THE ACT WHERE THE POLICY ASSOCIATION IS OBSOLETE,
...
CREATE TABLE ENT_VRSN_TBL (
	...
	VRSN_SEQ_ID NUMERIC(10) UNIQUE NOT NULL, -- UNIQUE VERSION SEQUENCE FOR THE ENTITY VERSION
...
CREATE TABLE ENT_REL_TBL (
	...
	EFFT_VRSN_SEQ_ID NUMERIC(10) NOT NULL, -- THE SOURCE VERSION SEQUENCE WHERE THE RELATIONSHIP BECAME ACTIVE
	OBSLT_VRSN_SEQ_ID NUMERIC(10), -- THE SOURCE VERSION SEQUENCE WHERE THE RELATIONSHIP BECAME OBSOLETE
...
CREATE TABLE ENT_ADDR_TBL (
	...
	EFFT_VRSN_SEQ_ID NUMERIC(10) NOT NULL, -- THE VERSION WHEN THE ADDRESS RELATIONSHIP BECAME ACTIVE
	OBSLT_VRSN_SEQ_ID NUMERIC(10), -- THE VERSION WHEN THE ADDRESS RELATIOSHIP IS NOT ACTIVE
...
CREATE TABLE ENT_ADDR_CMP_VAL_TBL (
	VAL_SEQ_ID NUMERIC(10) NOT NULL,
...
CREATE TABLE ENT_ADDR_CMP_TBL (
	...
	VAL_SEQ_ID NUMERIC(10) NOT NULL, -- THE CHAR(16) FOR THE ADDRESS VALUE
...
CREATE TABLE ENT_NAME_TBL (
	...
	EFFT_VRSN_SEQ_ID NUMERIC(10) NOT NULL, -- THE ENTITY SEQUENCE AT WHICH THE NAME BECOMES ACTIVE
	OBSLT_VRSN_SEQ_ID NUMERIC(10), -- THE ENTITY SEQUENCE WHERE THE NAME IS NO LONGER ACTIVE
...
CREATE TABLE ENT_NAME_CMP_TBL (
	...
	VAL_SEQ_ID NUMERIC(10) NOT NULL, -- THE PHONETIC CODE FOR THE NAME
...
CREATE TABLE ENT_EXT_TBL (
	...
	EFFT_VRSN_SEQ_ID NUMERIC(10) NOT NULL, -- EFFECTIVE VERSION IDENTIFIER
	OBSLT_VRSN_SEQ_ID NUMERIC(10), -- OBSOLETIONS VERSION SEQ
...
CREATE TABLE ENT_ID_TBL (
	...
	EFFT_VRSN_SEQ_ID NUMERIC(10) NOT NULL, -- THE VERSION WHEN THE IDENTIFIER WAS ACTIVE
	OBSLT_VRSN_SEQ_ID NUMERIC(10), -- OBSOLETE VERSION SEQUENCE ID
	AUT_ID UUID NOT NULL, -- THE ASSIGNING AUTHORITY OF THE IDENTIFIER
	ID_VAL VARCHAR(64) NOT NULL, -- THE VALUE OF THE IDENTIFIER
...
CREATE TABLE ENT_TEL_TBL (
	...
	EFFT_VRSN_SEQ_ID NUMERIC(10) NOT NULL, -- THE VERSION SEQUENCE WHEN THE ADDRESS IS ACTIVE
	OBSLT_VRSN_SEQ_ID NUMERIC(10), -- THE VERSION SEQUENCE WHEN TH ADDRESS IS OBSOLETE
...
CREATE TABLE PLC_SVC_TBL (
	...
	EFFT_VRSN_SEQ_ID NUMERIC(10) NOT NULL, -- EFFECTIVE VERSION SEQUENCE
	OBSLT_VRSN_SEQ_ID NUMERIC(10), -- THE VERSION WHEERE THE SERVICE WAS REMOVED
...
CREATE TABLE PSN_LNG_TBL (
	...
	EFFT_VRSN_SEQ_ID NUMERIC(10) NOT NULL, -- THE VERSION OF THE PERSON ENTITY WHERE THIS BECOMES ACTIVE
	OBSLT_VRSN_SEQ_ID NUMERIC(10), -- THE OBSOLETION VERISON OF THE PERSON LANGUAGE
...
CREATE TABLE ACT_NOTE_TBL (
	...
	EFFT_VRSN_SEQ_ID NUMERIC(10) NOT NULL, -- THE VERSION OF HTE ACT WHERE THE NOTE WAS ADDED
	OBSLT_VRSN_SEQ_ID NUMERIC(10), -- THE VERSION OF THE ACT WHERE THE NOTE WAS REMOVED
...
CREATE TABLE ENT_NOTE_TBL (
	...
	EFFT_VRSN_SEQ_ID NUMERIC(10) NOT NULL, -- THE VERSION OF HTE ENTITY WHERE THE NOTE WAS ADDED
	OBSLT_VRSN_SEQ_ID NUMERIC(10), -- THE VERSION OF THE ENTITY WHERE THE NOTE WAS REMOVED
	AUTH_ENT_ID UUID NOT NULL, -- THE UAHTOR WHO CREATED THE NOTE (SINCE A NOTE CAN BE ATTACHED WITHOUT CREATING A NEW VERSION)
	NOTE_TXT BLOB SUB_TYPE TEXT NOT NULL, -- THE NOTE BLOB SUB_TYPE TEXT
...
CREATE TABLE ACT_PTCPT_TBL (
	...
	EFFT_VRSN_SEQ_ID NUMERIC(10) NOT NULL, -- THE VERSION OF THE ACT WHERE THE PARTICIPATION IS ACTIVATED
	OBSLT_VRSN_SEQ_ID NUMERIC(10), -- THE VERISON OF THE ACT WHERE THE PARTICIPATION IS NO LONGER ACTIVE
	...
	ACT_PTCPT_SEQ_ID NUMERIC(10) NOT NULL,
...
CREATE TRIGGER TG_ACT_PTCPT_TBL_SEQ FOR ACT_PTCPT_TBL ACTIVE BEFORE INSERT POSITION 0 AS BEGIN
	NEW.ACT_PTCPT_SEQ_ID = NEXT VALUE FOR ACT_PTCPT_SEQ;
END!!
SET TERM ; !!
...
BEGIN
	FOR SELECT '1.0.0.0' FROM RDB$DATABASE
		INTO :VER
	DO BEGIN
		SUSPEND;
	END
...
UPDATE SEC_USR_TBL SET CRT_USR_ID = char_to_uuid('C96859F0-043C-4480-8DAB-F69D6E86696C');

-- BUILT IN OPENIZ POLICIES
INSERT INTO SEC_POL_TBL (POL_ID, OID, POL_NAME, CRT_USR_ID) VALUES (char_to_uuid('da73c05a-3159-48c8-bbcb-741911d91cd2'), '1.3.6.1.4.1.33349.3.1.5.9.2', 'Unrestricted All', char_to_uuid('fadca076-3690-4a6e-af9e-f1cd68e8c7e8'));
INSERT INTO SEC_POL_TBL (POL_ID, OID, POL_NAME, CRT_USR_ID) VALUES (char_to_uuid('ea73c05a-3159-48c8-bbcb-741911d91cd2'), '1.3.6.1.4.1.33349.3.1.5.9.2.0', 'Unrestricted Administrative Function', char_to_uuid('fadca076-3690-4a6e-af9e-f1cd68e8c7e8'));
INSERT INTO SEC_POL_TBL (POL_ID, OID, POL_NAME, CRT_USR_ID) VALUES (char_to_uuid('d80ac1cf-3d6e-429f-a4a0-88c0bbbc839d'), '1.3.6.1.4.1.33349.3.1.5.9.2.0.1', 'Change Password', char_to_uuid('fadca076-3690-4a6e-af9e-f1cd68e8c7e8'));
INSERT INTO SEC_POL_TBL (POL_ID, OID, POL_NAME, CRT_USR_ID) VALUES (char_to_uuid('9c0d65ac-613e-4a67-8bc6-5ce2c0b42160'), '1.3.6.1.4.1.33349.3.1.5.9.2.0.2', 'Create Role', char_to_uuid('fadca076-3690-4a6e-af9e-f1cd68e8c7e8'));
INSERT INTO SEC_POL_TBL (POL_ID, OID, POL_NAME, CRT_USR_ID) VALUES (char_to_uuid('79bcc227-0d13-4fbf-a83e-f2b9fce34151'), '1.3.6.1.4.1.33349.3.1.5.9.2.0.3', 'Alter Role', char_to_uuid('fadca076-3690-4a6e-af9e-f1cd68e8c7e8'));
INSERT INTO SEC_POL_TBL (POL_ID, OID, POL_NAME, CRT_USR_ID) VALUES (char_to_uuid('ab8642cb-28e4-4e9e-bd7b-d6dc72b729b2'), '1.3.6.1.4.1.33349.3.1.5.9.2.0.4', 'Create Identity', char_to_uuid('fadca076-3690-4a6e-af9e-f1cd68e8c7e8'));
INSERT INTO SEC_POL_TBL (POL_ID, OID, POL_NAME, CRT_USR_ID) VALUES (char_to_uuid('bb8642cb-28e4-4e9e-bd7b-d6dc72b729b2'), '1.3.6.1.4.1.33349.3.1.5.9.2.0.5', 'Create Device', char_to_uuid('fadca076-3690-4a6e-af9e-f1cd68e8c7e8'));
INSERT INTO SEC_POL_TBL (POL_ID, OID, POL_NAME, CRT_USR_ID) VALUES (char_to_uuid('cb8642cb-28e4-4e9e-bd7b-d6dc72b729b2'), '1.3.6.1.4.1.33349.3.1.5.9.2.0.6', 'Create Application', char_to_uuid('fadca076-3690-4a6e-af9e-f1cd68e8c7e8'));
INSERT INTO SEC_POL_TBL (POL_ID, OID, POL_NAME, CRT_USR_ID) VALUES (char_to_uuid('db8642cb-28e4-4e9e-bd7b-d6dc72b729b2'), '1.3.6.1.4.1.33349.3.1.5.9.2.0.7', 'Administer Concept Dictionary', char_to_uuid('fadca076-3690-4a6e-af9e-f1cd68e8c7e8'));
INSERT INTO SEC_POL_TBL (POL_ID, OID, POL_NAME, CRT_USR_ID) VALUES (char_to_uuid('eb8642cb-28e4-4e9e-bd7b-d6dc72b729b2'), '1.3.6.1.4.1.33349.3.1.5.9.2.0.8', 'Alter Identity', char_to_uuid('fadca076-3690-4a6e-af9e-f1cd68e8c7e8'));
INSERT INTO SEC_POL_TBL (POL_ID, OID, POL_NAME, CRT_USR_ID) VALUES (char_to_uuid('fb8642cb-28e4-4e9e-bd7b-d6dc72b729b2'), '1.3.6.1.4.1.33349.3.1.5.9.2.0.9', 'Alter Policy', char_to_uuid('fadca076-3690-4a6e-af9e-f1cd68e8c7e8'));
INSERT INTO SEC_POL_TBL (POL_ID, OID, POL_NAME, CRT_USR_ID) VALUES (char_to_uuid('fa8642cb-28e4-4e9e-bd7b-d6dc72b729b2'), '1.3.6.1.4.1.33349.3.1.5.9.2.0.10', 'Administer Data Warehouse', char_to_uuid('fadca076-3690-4a6e-af9e-f1cd68e8c7e8'));

INSERT INTO SEC_POL_TBL (POL_ID, OID, POL_NAME, CRT_USR_ID) VALUES (char_to_uuid('d15b96ab-646c-4c00-9a58-ea09eee67d7c'), '1.3.6.1.4.1.33349.3.1.5.9.2.1', 'Login', char_to_uuid('fadca076-3690-4a6e-af9e-f1cd68e8c7e8'));
INSERT INTO SEC_POL_TBL (POL_ID, OID, POL_NAME, CRT_USR_ID) VALUES (char_to_uuid('e15b96ab-646c-4c00-9a58-ea09eee67d7c'), '1.3.6.1.4.1.33349.3.1.5.9.2.1.0', 'Login as a Service', char_to_uuid('fadca076-3690-4a6e-af9e-f1cd68e8c7e8'));

INSERT INTO SEC_POL_TBL (POL_ID, OID, POL_NAME, CRT_USR_ID) VALUES (char_to_uuid('f6840336-4e20-4bc0-b965-baa6d7c80be3'), '1.3.6.1.4.1.33349.3.1.5.9.2.2', 'Unrestricted Clinical Data', char_to_uuid('fadca076-3690-4a6e-af9e-f1cd68e8c7e8'));
INSERT INTO SEC_POL_TBL (POL_ID, OID, POL_NAME, CRT_USR_ID) VALUES (char_to_uuid('b81daf47-17a5-465e-a5fd-706b168b0265'), '1.3.6.1.4.1.33349.3.1.5.9.2.2.0', 'Query Clinical Data', char_to_uuid('fadca076-3690-4a6e-af9e-f1cd68e8c7e8'));
INSERT INTO SEC_POL_TBL (POL_ID, OID, POL_NAME, CRT_USR_ID) VALUES (char_to_uuid('d7276921-a078-4348-95f2-ed3cde83e607'), '1.3.6.1.4.1.33349.3.1.5.9.2.2.1', 'Write Clinical Data', char_to_uuid('fadca076-3690-4a6e-af9e-f1cd68e8c7e8'));
INSERT INTO SEC_POL_TBL (POL_ID, OID, POL_NAME, CRT_USR_ID) VALUES (char_to_uuid('2e027dee-ede4-4731-b7fa-cb67ae0586be'), '1.3.6.1.4.1.33349.3.1.5.9.2.2.2', 'Delete Clinical Data', char_to_uuid('fadca076-3690-4a6e-af9e-f1cd68e8c7e8'));
INSERT INTO SEC_POL_TBL (POL_ID, OID, POL_NAME, CRT_USR_ID) VALUES (char_to_uuid('5fb731bf-4e59-4863-80bd-51757d58ea3b'), '1.3.6.1.4.1.33349.3.1.5.9.2.2.3', 'Read Clinical Data', char_to_uuid('fadca076-3690-4a6e-af9e-f1cd68e8c7e8'));
INSERT INTO SEC_POL_TBL (POL_ID, OID, POL_NAME, CRT_USR_ID) VALUES (char_to_uuid('5fb731bf-4e59-4863-80bd-51757d58ea9a'), '1.3.6.1.4.1.33349.3.1.5.9.2.2.4', 'Export Clinical Data', char_to_uuid('fadca076-3690-4a6e-af9e-f1cd68e8c7e8'));
INSERT INTO SEC_POL_TBL (POL_ID, OID, POL_NAME, CRT_USR_ID) VALUES (char_to_uuid('dea891aa-224d-4859-81b3-c1eb2750067e'), '1.3.6.1.4.1.33349.3.1.5.9.2.3', 'Override Disclosure', char_to_uuid('fadca076-3690-4a6e-af9e-f1cd68e8c7e8'));
INSERT INTO SEC_POL_TBL (POL_ID, OID, POL_NAME, CRT_USR_ID) VALUES (char_to_uuid('eea891aa-224d-4859-81b3-c1eb2750067e'), '1.3.6.1.4.1.33349.3.1.5.9.2.4', 'Unrestricted Metadata', char_to_uuid('fadca076-3690-4a6e-af9e-f1cd68e8c7e8'));
INSERT INTO SEC_POL_TBL (POL_ID, OID, POL_NAME, CRT_USR_ID) VALUES (char_to_uuid('fea891aa-224d-4859-81b3-c1eb2750067e'), '1.3.6.1.4.1.33349.3.1.5.9.2.4.0', 'Read Metadata', char_to_uuid('fadca076-3690-4a6e-af9e-f1cd68e8c7e8'));

INSERT INTO SEC_POL_TBL (POL_ID, OID, POL_NAME, CRT_USR_ID) VALUES (char_to_uuid('0ea891aa-224d-4859-81b3-c1eb2750067e'), '1.3.6.1.4.1.33349.3.1.5.9.2.10', 'Access Client Administrative Function', char_to_uuid('fadca076-3690-4a6e-af9e-f1cd68e8c7e8'));

INSERT INTO SEC_POL_TBL (POL_ID, OID, POL_NAME, CRT_USR_ID) VALUES (char_to_uuid('0a8642cb-28e4-4e9e-bd7b-d6df72b729b2'), '1.3.6.1.4.1.33349.3.1.5.9.2.5', 'Unrestricted Data Warehouse', char_to_uuid('fadca076-3690-4a6e-af9e-f1cd68e8c7e8'));
INSERT INTO SEC_POL_TBL (POL_ID, OID, POL_NAME, CRT_USR_ID) VALUES (char_to_uuid('1a8642cb-28e4-4e9e-bd7b-d6df72b729b2'), '1.3.6.1.4.1.33349.3.1.5.9.2.5.0', 'Write Warehouse Data', char_to_uuid('fadca076-3690-4a6e-af9e-f1cd68e8c7e8'));
INSERT INTO SEC_POL_TBL (POL_ID, OID, POL_NAME, CRT_USR_ID) VALUES (char_to_uuid('2a8642cb-28e4-4e9e-bd7b-d6df72b729b2'), '1.3.6.1.4.1.33349.3.1.5.9.2.5.1', 'Delete Warehouse Data', char_to_uuid('fadca076-3690-4a6e-af9e-f1cd68e8c7e8'));
INSERT INTO SEC_POL_TBL (POL_ID, OID, POL_NAME, CRT_USR_ID) VALUES (char_to_uuid('3a8642cb-28e4-4e9e-bd7b-d6df72b729b2'), '1.3.6.1.4.1.33349.3.1.5.9.2.5.2', 'Read Warehouse Data', char_to_uuid('fadca076-3690-4a6e-af9e-f1cd68e8c7e8'));
INSERT INTO SEC_POL_TBL (POL_ID, OID, POL_NAME, CRT_USR_ID) VALUES (char_to_uuid('4a8642cb-28e4-4e9e-bd7b-d6df72b729b2'), '1.3.6.1.4.1.33349.3.1.5.9.2.5.3', 'Query Warehouse Data', char_to_uuid('fadca076-3690-4a6e-af9e-f1cd68e8c7e8'));

INSERT INTO SEC_POL_TBL (POL_ID, OID, POL_NAME, CRT_USR_ID) VALUES (char_to_uuid('36f1ed35-552e-421a-8f59-629561ab9eb6'), '1.3.6.1.4.1.33349.3.1.5.9.3', 'Restricted Information', char_to_uuid('fadca076-3690-4a6e-af9e-f1cd68e8c7e8'));

-- INSERT THE DEFAULT ASSOCIATIONS
-- CREATE USERS ROLE
INSERT INTO SEC_ROL_TBL (ROL_ID, ROL_NAME, DESCR, CRT_USR_ID) VALUES (char_to_uuid('f4e58ae8-8bbd-4635-a6d4-8a195b143436'), 'USERS', 'Group for users who have login access', char_to_uuid('fadca076-3690-4a6e-af9e-f1cd68e8c7e8'));
...
INSERT INTO SEC_ROL_TBL (ROL_ID, ROL_NAME, DESCR, CRT_USR_ID) VALUES (char_to_uuid('f6d2ba1d-5bb5-41e3-b7fb-2ec32418b2e1'), 'ADMINISTRATORS', 'Group for users who have administrative access', char_to_uuid('fadca076-3690-4a6e-af9e-f1cd68e8c7e8'));
...
-- CLINICAL STAFF
INSERT INTO SEC_ROL_TBL (ROL_ID, ROL_NAME, DESCR, CRT_USR_ID) VALUES (char_to_uuid('43167DCB-6F77-4F37-8222-133E675B4434'), 'CLINICAL_STAFF', 'Group for clinic staff', char_to_uuid('fadca076-3690-4a6e-af9e-f1cd68e8c7e8'));
...
INSERT INTO SEC_ROL_TBL (ROL_ID, ROL_NAME, DESCR, CRT_USR_ID) VALUES (char_to_uuid('54B7677C-682B-425F-A937-3AA03D5951F1'), 'SYNCHRONIZERS', 'Group for user SYNCHRONIZERS. Identifies the functions that are used for synchronization. EDITING THIS ROLE MAY INTRODUCE SECURITY BREACHES', char_to_uuid('fadca076-3690-4a6e-af9e-f1cd68e8c7e8'));
...
-- CREATE DEVICE ROLE
INSERT INTO SEC_ROL_TBL (ROL_ID, ROL_NAME, DESCR, CRT_USR_ID) VALUES (char_to_uuid('613d05a0-dd0d-4516-a30c-e733741885f0'), 'DEVICE', 'Represents a device in the system. Identifies the functions that are used for devices. EDITING THIS ROLE MAY INTRODUCE SECURITY BREACHES', char_to_uuid('fadca076-3690-4a6e-af9e-f1cd68e8c7e8'));
...
INSERT INTO PHON_ALG_TBL (ALG_ID, ALG_NAME, HDLR_CLS, CRT_USR_ID)  VALUES (char_to_uuid('402cd339-d0e4-46ce-8fc2-12a4b0e17226'), 'NONE', NULL, char_to_uuid('fadca076-3690-4a6e-af9e-f1cd68e8c7e8'));
INSERT INTO PHON_ALG_TBL (ALG_ID, ALG_NAME, HDLR_CLS, CRT_USR_ID)  VALUES (char_to_uuid('3352a79a-d2e0-4e0c-9b48-6fd2a202c681'), 'SOUNDEX', 'SanteDB.Core.Services.Impl.PhoneticAlgorithms.SoundexPhoneticAlgorithmHandler, SanteDB.Core, Version=0.6.0.0', char_to_uuid('fadca076-3690-4a6e-af9e-f1cd68e8c7e8'));
INSERT INTO PHON_ALG_TBL (ALG_ID, ALG_NAME, HDLR_CLS, CRT_USR_ID)  VALUES (char_to_uuid('d79a4dc6-66a6-4602-8fcb-7dc09a895793'), 'METAPHONE', 'SanteDB.Core.Services.Impl.PhoneticAlgorithms.MetaphonePhoneticAlgorithmHandler, SanteDB.Core, Version=0.6.0.0', char_to_uuid('fadca076-3690-4a6e-af9e-f1cd68e8c7e8'));

INSERT INTO CD_REL_TYP_CDTBL (REL_TYP_ID, REL_NAME, MNEMONIC, CRT_USR_ID) VALUES (char_to_uuid('2c4dafc2-566a-41ae-9ebc-3097d7d22f4a'), 'Same as', 'SameAs', char_to_uuid('fadca076-3690-4a6e-af9e-f1cd68e8c7e8'));
INSERT INTO CD_REL_TYP_CDTBL (REL_TYP_ID, REL_NAME, MNEMONIC, CRT_USR_ID) VALUES (char_to_uuid('ad27293d-433c-4b75-88d2-b5360cd95450'), 'Inverse of', 'InverseOf', char_to_uuid('fadca076-3690-4a6e-af9e-f1cd68e8c7e8'));
INSERT INTO CD_REL_TYP_CDTBL (REL_TYP_ID, REL_NAME, MNEMONIC, CRT_USR_ID) VALUES (char_to_uuid('a159d45b-3c34-4e1b-9b75-9193a7528ced'), 'Member of', 'MemberOf', char_to_uuid('fadca076-3690-4a6e-af9e-f1cd68e8c7e8'));
INSERT INTO CD_REL_TYP_CDTBL (REL_TYP_ID, REL_NAME, MNEMONIC, CRT_USR_ID) VALUES (char_to_uuid('ae8b4f2f-009f-4e0d-b35e-5a89555c5947'), 'Negation of', 'NegationOf', char_to_uuid('fadca076-3690-4a6e-af9e-f1cd68e8c7e8'));
INSERT INTO CD_REL_TYP_CDTBL (REL_TYP_ID, REL_NAME, MNEMONIC, CRT_USR_ID) VALUES (char_to_uuid('ae8b4f2f-009f-4e0d-b35e-5a89555c5980'), 'Wider-Than', 'WiderThan', char_to_uuid('fadca076-3690-4a6e-af9e-f1cd68e8c7e8'));
INSERT INTO CD_REL_TYP_CDTBL (REL_TYP_ID, REL_NAME, MNEMONIC, CRT_USR_ID) VALUES (char_to_uuid('ae8b4f2f-009f-4e0d-b35e-5a89555c5990'), 'Narrower-Than', 'NarrowerThan', char_to_uuid('fadca076-3690-4a6e-af9e-f1cd68e8c7e8'));
