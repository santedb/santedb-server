...
BEGIN
	...
	ELSE BEGIN
		...
		IF (VAR_USR_PWD = :PASSWD_IN) THEN BEGIN
			UPDATE SEC_USR_TBL SET 
				...
				UPD_USR_ID = char_to_uuid('fadca076-3690-4a6e-af9e-f1cd68e8c7e8'),
	...
	FOR SELECT USR_ID, CLS_ID, USR_NAME, EMAIL, EMAIL_CNF, PHN_NUM, 
				...
				LAST_LOGIN_UTC, CRT_UTC, CRT_USR_ID, OBSLT_UTC, OBSLT_USR_ID,
				UPD_UTC, UPD_USR_ID, :VAR_USR_ERR
			FROM SEC_USR_TBL
			WHERE
				USR_ID = :VAR_USR_ID
			INTO 
...
(
	...
	CRT_USR_ID UUID, -- THE USER WHICH IS RESPONSIBLE FOR THE CREATION OF THE APP
...
BEGIN
	FOR SELECT * 
		...
		INTO :APP_ID, :APP_PUB_ID, :APP_SCRT, :CRT_UTC,
			:CRT_USR_ID, :OBSLT_UTC, :OBSLT_USR_ID, :RPLC_APP_ID
	DO BEGIN
		SUSPEND;
	END
END!!
...
CREATE PROCEDURE AUTH_DEV (
	...
	CRT_USR_ID UUID, -- THE USER WHICH CREATED TEH DEVICE
...
BEGIN
	FOR SELECT * 
		...
		FETCH FIRST 1 ROW ONLY
		INTO :DEV_ID, :DEV_SCRT, :DEV_PUB_ID, :CRT_UTC,
			:CRT_USR_ID, :OBSLT_UTC, :OBSLT_USR_ID, :RPLC_DEV_ID
	DO BEGIN
		SUSPEND;
	END
END!!
