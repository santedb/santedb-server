...
namespace SanteDB.Persistence.Data.ADO.Data.Model.Entities
{
	...
	/// </summary>
	[Table("ent_vrsn_tbl")]
	public class DbEntityVersion : DbVersionedData, IDbPrivateKey
    {
        /// <summary>
        /// Gets or sets the key
        /// </summary>
        [Column("ent_id"), ForeignKey(typeof(DbEntity), nameof(DbEntity.PrivateKey)), AlwaysJoin]
        ...
        public int StatusConceptPrivateKey { get; set; }

        /// <summary>
        /// Gets the private key
        /// </summary>
        [PublicKeyRef(nameof(StatusConceptPrivateKey))]
        ...
        public int? TypeConceptPrivateKey { get; set; }

        /// <summary>
        /// Type concept private key
        /// </summary>
