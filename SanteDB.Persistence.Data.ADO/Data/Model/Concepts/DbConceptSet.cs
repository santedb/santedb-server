...
namespace SanteDB.Persistence.Data.ADO.Data.Model.Concepts
{
	...
	public class DbConceptSet : DbNonVersionedBaseData
	{
        ...
        /// <summary>
        /// Gets the public key of the set
        /// </summary>
        [Column("uuid"), AutoGenerated, PublicKey]
	...
	public class DbConceptSetConceptAssociation 
	{
		...
		[Column("cd_id"), ForeignKey(typeof(DbConcept), nameof(DbConcept.PrivateKey)), PrimaryKey]
        public Int32 ConceptPrivateKey { get; set; }

        /// <summary>
        /// Public key of concept key
        /// </summary>
        [PublicKeyRef(nameof(ConceptPrivateKey))]
		...
		[Column("set_id"), ForeignKey(typeof(DbConceptSet), nameof(DbConceptSet.PrivateKey)), PrimaryKey]
        public Int32 ConceptSetPrivateKey { get; set; }

        /// <summary>
        /// Gets the concept set key
        /// </summary>
        [PublicKeyRef(nameof(ConceptSetPrivateKey))]
