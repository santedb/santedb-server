...
using SanteDB.Persistence.Data.ADO.Resources;
using System;
...
using SanteDB.Persistence.Data.ADO.Data.SQL;
...
namespace SanteDB.Persistence.Data.ADO.Configuration.UserInterface
{
    /// <summary>
    ...
    public class AdoPersistenceConfigurableFeature : IScriptableConfigurableFeature, IDataboundFeature, IReportProgressChanged
    {
        ...
        public List<IDataUpdate> Updates
        {
            get
            {
                ...
                foreach(var nam in typeof(AdoPersistenceConfigurableFeature).Assembly.GetManifestResourceNames())
                    if(nam.StartsWith("SanteDB.Persistence.Data.ADO.Data.SQL.Updates"))
                    {
        ...
        public bool IsConfigured(XmlDocument configurationDom)
        {
            ...
            var adoConfiguration = configurationDom.GetSection("SanteDB.persistence.data.ado") as AdoConfiguration;
