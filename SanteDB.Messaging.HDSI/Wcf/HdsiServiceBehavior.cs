...
namespace SanteDB.Messaging.HDSI.Wcf
{
    ...
    /// Data implementation
    /// </summary>
    [ServiceBehavior(ConfigurationName = "HDSI", InstanceContextMode = InstanceContextMode.PerCall)]
    ...
    public class HdsiServiceBehavior : IHdsiServiceContract
    {
            ...
            try
            {
                ...
                if (handler != null)
                {
                        ...
                        WebOperationContext.Current.IncomingRequest.UriTemplateMatch.QueryParameters["_all"] == "true")
                    {
                        ...
                        ObjectExpander.ExpandProperties(retVal, SanteDB.Core.Model.Query.NameValueCollection.ParseQueryString(WebOperationContext.Current.IncomingRequest.UriTemplateMatch.RequestUri.Query));
                        ObjectExpander.ExcludeProperties(retVal, SanteDB.Core.Model.Query.NameValueCollection.ParseQueryString(WebOperationContext.Current.IncomingRequest.UriTemplateMatch.RequestUri.Query));
        ...
        public XmlSchema GetSchema(int schemaId)
        {
            ...
            try
            {
                ...
                foreach (var cls in typeof(IHdsiServiceContract).GetCustomAttributes<ServiceKnownTypeAttribute>().Select(o => o.Type))
