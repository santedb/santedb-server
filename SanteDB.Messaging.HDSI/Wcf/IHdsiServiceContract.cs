...
namespace SanteDB.Messaging.HDSI.Wcf
{
	...
	/// </summary>
	[ServiceContract(Namespace = "http://santedb.org/hdsi/1.0", Name = "HDSI", ConfigurationName = "HDSI_1.0")]
    ...
    public interface IHdsiServiceContract 
    {
        ...
        [SwaggerWcfPath("Service Availability Status", "Forces the service to respond with a 204 if the HDSI is running at this endpoint", ExternalDocsUrl = "http://santedb.org/artifacts/1.0/hdsi/", ExternalDocsDescription = "HDSI Data Contract Documentation")]
        void Ping();
        ...
        [SwaggerWcfPath("Search Resource", "Conducts a search of the identified resource type. The search query parameters are provided in HDSI query specification format", ExternalDocsUrl = "http://santedb.org/artifacts/1.0/hdsi/", ExternalDocsDescription = "HDSI Data Contract Documentation")]
        ...
        [SwaggerWcfPath("Head Search Resource", "Conducts a search of the identified resource type using the HDSI query provided, however only returns HTTP headers for the search", ExternalDocsUrl = "http://santedb.org/artifacts/1.0/hdsi/", ExternalDocsDescription = "HDSI Data Contract Documentation")]
        ...
        [SwaggerWcfPath("Head Resource", "Retrieves the HTTP header information for the identified resource", ExternalDocsUrl = "http://santedb.org/artifacts/1.0/hdsi/", ExternalDocsDescription = "HDSI Data Contract Documentation")]
        ...
        [SwaggerWcfPath("Get Resource History", "Provides a complete list of all changes made to the identified resource", ExternalDocsUrl = "http://santedb.org/artifacts/1.0/hdsi/", ExternalDocsDescription = "HDSI Data Contract Documentation")]
        ...
        [SwaggerWcfPath("Patch Resource", "Performs a partial update of the resource using the provided patch information", ExternalDocsUrl = "http://santedb.org/artifacts/1.0/hdsi/", ExternalDocsDescription = "HDSI Data Contract Documentation")]
        ...
        [SwaggerWcfPath("Get Changeset", "Retrieves the patches that have been applied to the identified resource", ExternalDocsUrl = "http://santedb.org/artifacts/1.0/hdsi/", ExternalDocsDescription = "HDSI Data Contract Documentation")]
        ...
        [SwaggerWcfPath("Get Resource Version", "Retrieves a specific version of a resource from the IMS datastore", ExternalDocsUrl = "http://santedb.org/artifacts/1.0/hdsi/", ExternalDocsDescription = "HDSI Data Contract Documentation")]
        ...
        /// </summary>
        [SwaggerWcfPath("Create Resource", "Creates a the specified resources in the IMS datastore. If the resource already exists, a 409 conflict is returned", ExternalDocsUrl = "http://santedb.org/artifacts/1.0/hdsi/", ExternalDocsDescription = "HDSI Data Contract Documentation")]
        ...
        /// </summary>
        [SwaggerWcfPath("Update Resource", "Creates a new version of the identified resource in the IMS datastore. If the resource does not exist, returns a 404", ExternalDocsUrl = "http://santedb.org/artifacts/1.0/hdsi/", ExternalDocsDescription = "HDSI Data Contract Documentation")]
        ...
        [SwaggerWcfPath("Create or Update Resource", "Updates the identified resource if it exists, otherwise creates it in the IMS data store", ExternalDocsUrl = "http://santedb.org/artifacts/1.0/hdsi/", ExternalDocsDescription = "HDSI Data Contract Documentation")]
        ...
        /// </summary>
        [SwaggerWcfPath("Logically Delete Resource", "Performs a logical delete (obsoletion) of the identified resource", ExternalDocsUrl = "http://santedb.org/artifacts/1.0/hdsi/", ExternalDocsDescription = "HDSI Data Contract Documentation")]
        ...
        [SwaggerWcfPath("Get Server Schema", "Gets a complete schema of the HDSI objects supported by this interface")]
