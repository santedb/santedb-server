...
--#!
 ...
 CREATE TABLE aud_obj_tbl (
	id UUID NOT NULL, -- UNIQUE IDENTIFIER FOR THE AUDIT OBJECT
...
CREATE TABLE aud_act_tbl (
	id UUID NOT NULL, -- UNIQUE IDENTIFIER FOR THE AUDIT ACTOR ENTRY
...
CREATE TABLE aud_act_assoc_tbl (
	id UUID NOT NULL, -- UNIQUE IDENTIFIER FOR THE AUDIT ACTOR
...
CREATE TABLE aud_meta_tbl (
	...
	attr INT NOT NULL,
	val BLOB SUB_TYPE TEXT NOT NULL,
