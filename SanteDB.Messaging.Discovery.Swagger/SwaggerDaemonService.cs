...
namespace SanteDB.Messaging.Discovery.Swagger
{
    /// <summary>
    /// Represents a daemon service that exports Swagger documentation
    /// </summary>
    [Description("Swagger API Documentation")]
    [TraceSource("SanteDB.Messaging.Discovery.Swagger")]
    public class SwaggerDaemonService : IDaemonService
    {
        // HDSI Trace host
        private TraceSource m_traceSource = new TraceSource("SanteDB.Messaging.Discovery.Swagger");
            ...
            ApplicationContext.Current.Started += (o, e) =>
             {
                 ...
                 var info = new Info
                 {
                     Description = "SanteDB REST Endpoints Documentation",
                     Version = Assembly.GetEntryAssembly().GetName().Version.ToString(),
                     Title = $"SanteDB ({Assembly.GetEntryAssembly().GetCustomAttribute<AssemblyInformationalVersionAttribute>()?.InformationalVersion})"
                     // etc
                 };
