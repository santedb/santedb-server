...
namespace SanteDB.Persistence.Data.ADO.Test
{
    ...
    public class BulkQueryOperationTest :  DataTest
    {
        ...
        public void TestShouldPurgeData()
        {
            ...
            var keys = bulkService.QueryKeys(expression, 0, 10, out int otr);
            Assert.Greater(otr, 10);
            ...
            var keys2 = bulkService.QueryKeys(expression, 0, 10, out int ntr);
            Assert.AreEqual(otr - 10, ntr); // 10 should be "PURGED"
