...
namespace SanteDB.Messaging.RISI.Wcf
{
	...
	public partial interface IRisiContract
	{
        ...
        [SwaggerWcfPath("Execute Ad-hoc Query", "Filters data from the specified datamart using filtering by the exposed properties of the datamart schema in the HDSI query format")]
        ...
        [SwaggerWcfPath("Execute Stored Query", "Runs a previously registered stored query and returns the results. Filters can be applied using the HDSI query patterns")]
