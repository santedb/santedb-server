    ...
    public class BasicAuthorizationAccessPolicy : IAuthorizationPolicy
    {
        ...
        public bool Evaluate(EvaluationContext evaluationContext, ref object state)
        {
            try
            {
                ...
                if (pipService != null)
                    claims.AddRange(pipService.GetActivePolicies(identities[0]).Where(o => o.Rule == PolicyDecisionOutcomeType.Grant).Select(o => new System.Security.Claims.Claim(SanteDBClaimTypes.SanteDBGrantedPolicyClaim, o.Policy.Oid)));
                ...
                if (this.m_configuration?.Security?.BasicAuth?.RequireClientAuth == true)
                {
                    ...
                    else
                    {
                        ...
                        claims.Add(new System.Security.Claims.Claim(SanteDBClaimTypes.SanteDBApplicationIdentifierClaim, applicationPrincipal.Identity.Name));
                    }
                }
