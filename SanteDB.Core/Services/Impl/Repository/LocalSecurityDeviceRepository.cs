...
namespace SanteDB.Server.Core.Services.Impl
{
    ...
    public class LocalSecurityDeviceRepository : GenericLocalSecurityRepository<SecurityDevice>
    {
        ...
        /// DI constructor
        /// </summary>
        public LocalSecurityDeviceRepository(IDeviceIdentityProviderService identityProvider, IPolicyEnforcementService policyService, ILocalizationService localizationService, IDataPersistenceService<SecurityDevice> persistenceService, IPrivacyEnforcementService privacyService = null) : base(policyService, localizationService, persistenceService, privacyService)
        {
