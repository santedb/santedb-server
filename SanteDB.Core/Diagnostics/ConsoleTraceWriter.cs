...
namespace SanteDB.Server.Core.Diagnostics
{
    ...
    [Obsolete("Use SanteDB.Core.Diagnostics.Tracing.ConsoleTraceWriter", true)]
    public class ConsoleTraceWriter : SanteDB.Core.Diagnostics.Tracing.ConsoleTraceWriter
    {
        /// <summary>
