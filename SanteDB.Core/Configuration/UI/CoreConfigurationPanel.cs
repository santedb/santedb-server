...
namespace SanteDB.Core.Configuration.UI
{
    /// <summary>
    /// Core Configuration Panel for SanteDB
    /// </summary>
    public class CoreConfigurationPanel : IConfigurableFeature
    {
        ...
        public void Configure(XmlDocument configurationDom)
        {
            ...
            // Section
            var sectionDefinition = configurationDom.GetOrAddSectionDefinition(SanteDBConstants.SanteDBConfigurationName, typeof(ConfigurationSectionHandler));
            var section = configurationDom.GetSectionXml(SanteDBConstants.SanteDBConfigurationName);
        ...
        {
            var config = configurationDom.GetSection("SanteDB.core") as SanteDBConfiguration;
