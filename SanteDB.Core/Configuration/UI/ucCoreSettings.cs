...
namespace SanteDB.Core.Configuration.UI
{
    public partial class ucCoreSettings : UserControl
    {
        ...
        // Configuration
        private SanteDBConfiguration m_configuration = null;
        ...
        public SanteDBConfiguration Configuration {
            ...
            set
            {
                ...
                this.numThreadPool.DataBindings.Add(nameof(NumericUpDown.Value), this.m_configuration, nameof(SanteDBConfiguration.ThreadPoolSize));
                this.chkUnsignedApplets.DataBindings.Clear();
                this.chkUnsignedApplets.DataBindings.Add(nameof(CheckBox.Checked), this.m_configuration.Security, nameof(SanteDBSecurityConfiguration.AllowUnsignedApplets));
