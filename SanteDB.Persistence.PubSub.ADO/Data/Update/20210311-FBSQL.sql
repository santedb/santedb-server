 ...
 *	<canInstall>select COUNT(*) = 0 from rdb$relations where rdb$relation_name = 'SUB_TBL';</canInstall>
 *  <isInstalled mustSucceed="true">select COUNT(*) = 1 from rdb$relations where rdb$relation_name = 'SUB_TBL';</isInstalled>
 * </feature>
 */
