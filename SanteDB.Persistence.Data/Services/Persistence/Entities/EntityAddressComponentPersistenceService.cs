...
namespace SanteDB.Persistence.Data.Services.Persistence.Entities
{
    ...
    public class EntityAddressComponentPersistenceService : IdentifiedDataPersistenceService<EntityAddressComponent, DbEntityAddressComponent>
    {
        ...
        /// Prepare references
        /// </summary>
        protected override EntityAddressComponent PrepareReferences(DataContext context, EntityAddressComponent data)
        {
        ...
        /// </summary>
        protected override EntityAddressComponent DoConvertToInformationModel(DataContext context, DbEntityAddressComponent dbModel, params IDbIdentified[] referenceObjects)
        {
