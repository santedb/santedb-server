/** 
 * <feature scope="SanteDB.Persistence.Data.Performance" id="ZZ-PARTITION-PGSQL10" name="Performance: Partition PostgreSQL" applyRange="1.0.0.3-1.0.0.0"  invariantName="npgsql">
...
CREATE TABLE ent_rel_part_fam_tbl PARTITION OF ent_rel_part_tbl FOR VALUES IN ('1ee4e74f-542d-4544-96f6-266a6247f274', ,'a3ff423e-81d5-4571-8edf-03c295189a23' '0ff2ab03-6e0a-40d1-8947-04c4937b4cc4','24380d53-ea22-4820-9f06-8671f774f133','739457d0-835a-4a9c-811c-42b5e92ed1ca','1c0f931c-9c49-4a52-8fbf-5217c52ea778','38d66ec7-0cc8-4609-9675-b6ff91ede605','40d18ecc-8ff8-4e03-8e58-97a980f04060','48c59444-fec0-43b8-aa2c-7aedb70733ad','b630ba2c-8a00-46d8-bf64-870d381d8917','fa646df9-7d64-4d1f-ae9a-6261fd5fd6ae','29ff64e5-b564-411a-92c7-6818c02a9e48','bfcbb345-86db-43ba-b47e-e7411276ac7c','cd1e8904-31dc-4374-902d-c91f1de23c46','f172eee7-7f4b-4022-81d0-76393a1200ae','cdd99260-107c-4a4e-acaf-d7c9c7e90fdd');
...
create table ent_rel_part_scp_tbl partition of ent_rel_part_tbl for values in ('FCD37959-5BC2-48DB-BBB5-36AFD9EDF19A');
...
-- ADD PK
ALTER TABLE ent_rel_part_mdm_tbl ADD CONSTRAINT pk_ent_rel_part_mdm_tbl PRIMARY KEY (ent_rel_id);
...
ALTER TABLE ent_rel_part_scp_tbl ADD CONSTRAINT pk_ent_rel_part_scp_tbl PRIMARY KEY (ent_rel_id); 
--#!
...
ALTER TABLE ent_rel_part_scp_tbl ADD CONSTRAINT fk_ent_rel_part_scp_rel_typ_cd_id FOREIGN KEY (rel_typ_cd_id) REFERENCES cd_tbl (cd_id);
ALTER TABLE ent_rel_part_scp_tbl ADD CONSTRAINT fk_ent_rel_part_scp_src_ent_id FOREIGN KEY (src_ent_id) REFERENCES ent_tbl (ent_id);
ALTER TABLE ent_rel_part_scp_tbl ADD CONSTRAINT fk_ent_rel_part_scp_trg_ent_id FOREIGN KEY (trg_ent_id) REFERENCES ent_tbl (ent_id);

--#!

-- INDEX OF SRC_ENT_ID
CREATE INDEX ent_rel_part_dsdl_src_ent_id_idx ON ent_rel_part_dsdl_tbl(src_ent_id);
CREATE INDEX ent_rel_part_mdm_src_ent_id_idx ON ent_rel_part_mdm_tbl(src_ent_id);
...
CREATE INDEX ent_rel_part_scp_src_ent_id_idx ON ent_rel_part_scp_tbl(src_ent_id);
--#!
...
CREATE INDEX ent_rel_part_scp_rel_typ_idx ON ent_rel_part_scp_tbl(rel_typ_cd_id);
--#!
...
CREATE INDEX ent_rel_part_scp_trg_ent_id_idx ON ent_rel_part_scp_tbl(trg_ent_id);
--#!
...
CREATE UNIQUE INDEX ent_rel_part_scp_unq_enf_sha1 ON ent_rel_part_scp_tbl (digest((src_ent_id::text || trg_ent_id::text) || rel_typ_cd_id::text, 'sha1'::text)) WHERE obslt_vrsn_seq_id IS NULL;
--#!
